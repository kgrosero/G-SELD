...
class FeatureClass:
    ...
    def _load_audio(self, audio_path):
        ...
        #revisar esta normalizacion de 32768 porque es el unico lugar  donde normalizan 
    ...
    def _next_greater_power_of_2(x):
        ...
        #usado para saber cuantos bits son necesarios para alojar a X

    def _spectrogram(self, audio_input):
        _nb_ch = audio_input.shape[1]
        #1024//2=512
        nb_bins = self._nfft // 2
        #spectra size = (1440000 * 513 * 4)
    ...
    def _get_mel_spectrogram(self, linear_spectra):
        ...
        for ch_cnt in range(linear_spectra.shape[-1]):
            ...
            #reshape con -1 se fija en satisfacer la otra dimensión y ajustarse a la otra
    ...
    def get_labels_for_file(self, _desc_file):
    	# max frames, 4 represents the class and the 3 coordinates, 3*class represents the ov3 events
        list_label = np.zeros((self._max_label_frames, 4, 3*len(self._unique_classes)))	
        
        for frame_ind, active_event_list in _desc_file.items():
            if frame_ind < self._max_label_frames:
                if len(active_event_list) == 1:
                    list_label[frame_ind,0,active_event_list[0][0]] = 1
                    list_label[frame_ind,1,active_event_list[0][0]] = active_event_list[0][1]
                    list_label[frame_ind,2,active_event_list[0][0]] = active_event_list[0][2]
                    list_label[frame_ind,3,active_event_list[0][0]] = active_event_list[0][3]
                elif len(active_event_list) == 2:
                    if (active_event_list[0][0] == active_event_list[1][0]):
                        list_label[frame_ind,0,active_event_list[0][0]] = 1
                        list_label[frame_ind,1,active_event_list[0][0]] = active_event_list[0][1]
                        list_label[frame_ind,2,active_event_list[0][0]] = active_event_list[0][2]
                        list_label[frame_ind,3,active_event_list[0][0]] = active_event_list[0][3]
                        list_label[frame_ind,0,(active_event_list[1][0]+12)] = 1
                        list_label[frame_ind,1,(active_event_list[1][0]+12)] = active_event_list[1][1]
                        list_label[frame_ind,2,(active_event_list[1][0]+12)] = active_event_list[1][2]
                        list_label[frame_ind,3,(active_event_list[1][0]+12)] = active_event_list[1][3]
                    elif (active_event_list[0][0] != active_event_list[1][0]): 
                        list_label[frame_ind,0,active_event_list[0][0]] = 1 
                        list_label[frame_ind,0,active_event_list[1][0]] = 1 
                        list_label[frame_ind,1,active_event_list[0][0]] = active_event_list[0][1]
                        list_label[frame_ind,1,active_event_list[1][0]] = active_event_list[1][1]
                        list_label[frame_ind,2,active_event_list[0][0]] = active_event_list[0][2]
                        list_label[frame_ind,2,active_event_list[1][0]] = active_event_list[1][2]
                        list_label[frame_ind,3,active_event_list[0][0]] = active_event_list[0][3]
                        list_label[frame_ind,3,active_event_list[1][0]] = active_event_list[1][3]
                elif len(active_event_list) == 3:
                     # First case: C0 = C1 = C2
                    if (active_event_list[0][0] == active_event_list[1][0] == active_event_list[2][0]):
                        list_label[frame_ind,0,active_event_list[0][0]] = 1
                        list_label[frame_ind,1,active_event_list[0][0]] = active_event_list[0][1]
                        list_label[frame_ind,2,active_event_list[0][0]] = active_event_list[0][2]
                        list_label[frame_ind,3,active_event_list[0][0]] = active_event_list[0][3]
                        ...
                        list_label[frame_ind,2,active_event_list[1][0]+12] = active_event_list[1][2]
                        list_label[frame_ind,3,active_event_list[1][0]+12] = active_event_list[1][3]  
                        list_label[frame_ind,0,active_event_list[2][0]+24] = 1
                        list_label[frame_ind,1,active_event_list[2][0]+24] = active_event_list[2][1]
                        list_label[frame_ind,2,active_event_list[2][0]+24] = active_event_list[2][2]
                        list_label[frame_ind,3,active_event_list[2][0]+24] = active_event_list[2][3]
                    # Second case: C0 = C1 != C2 
                    elif (active_event_list[0][0] == active_event_list[1][0] != active_event_list[2][0]):
                        list_label[frame_ind,0,active_event_list[0][0]] = 1
                        list_label[frame_ind,1,active_event_list[0][0]] = active_event_list[0][1]
                        list_label[frame_ind,2,active_event_list[0][0]] = active_event_list[0][2]
                        list_label[frame_ind,3,active_event_list[0][0]] = active_event_list[0][3]
                        ...
                        list_label[frame_ind,2,active_event_list[1][0]+12] = active_event_list[1][2]
                        list_label[frame_ind,3,active_event_list[1][0]+12] = active_event_list[1][3]  
                        list_label[frame_ind,0,active_event_list[2][0]] = 1
                        list_label[frame_ind,1,active_event_list[2][0]] = active_event_list[2][1]
                        list_label[frame_ind,2,active_event_list[2][0]] = active_event_list[2][2]
                        list_label[frame_ind,3,active_event_list[2][0]] = active_event_list[2][3]                         
                    # Fifth case: C0 != C1 != C2                                                   
                    elif (active_event_list[0][0] != active_event_list[1][0] != active_event_list[2][0]):  
                        list_label[frame_ind,0,active_event_list[0][0]] = 1
                        list_label[frame_ind,1,active_event_list[0][0]] = active_event_list[0][1]
                        ...
                        list_label[frame_ind,2,active_event_list[2][0]] = active_event_list[2][2]
                        list_label[frame_ind,3,active_event_list[2][0]] = active_event_list[2][3]                        
        list_label = list_label.reshape((self._max_label_frames, -1))
        return list_label  
    ...
    def preprocess_features(self):
        ...
        if self._is_eval:
            ...
            for file_cnt, file_name in enumerate(os.listdir(self._feat_dir)):
                ...
                # here the normalization weigths are just calculated
                spec_scaler.partial_fit(feat_file)
                del feat_file
                #joblib.dump is used to keep in memory the value of spec_scaler and save it in normalized_features_wts_files 
            joblib.dump(
                spec_scaler,
        ...
        for file_cnt, file_name in enumerate(os.listdir(self._feat_dir)):
            print('{}: {}'.format(file_cnt, file_name))
            feat_file = np.load(os.path.join(self._feat_dir, file_name))
            # here the normalization weigths are applied to the features
    ...
    # used from cls data generator, and into dump DCASE2021 results in seld
    ...
    def regression_label_format_to_output_format(self, _sed_labels, _doa_labels):
        ...
        # para verificar si tiene dos valores (az, ele) o 3 (x,y,z)
        _is_polar = _doa_labels.shape[-1] == 2*3*_nb_classes
        _azi_labels, _ele_labels = None, None
        _x, _y, _z = None, None, None
        if _is_polar:
            _azi_labels = _doa_labels[:, :3*_nb_classes]
            _ele_labels = _doa_labels[:, 3*_nb_classes:]
        else:
            _x = _doa_labels[:, :3*_nb_classes]
            _y = _doa_labels[:, 3*_nb_classes:2*3*_nb_classes]
            _z = _doa_labels[:, 2*3*_nb_classes:]

        _output_dict = {}
        # range(_sed_labels.shape[0]) = 600
        for _frame_ind in range(_sed_labels.shape[0]):
            _tmp_ind = np.where(_sed_labels[_frame_ind, :])
            #print('class: ', len(_tmp_ind), _tmp_ind)
            if len(_tmp_ind[0]):
                _output_dict[_frame_ind] = []
                for _tmp_classe in _tmp_ind[0]:
                    if _is_polar:
                        if _tmp_classe >= 12 and _tmp_classe <= 23 :                        
                            _output_dict[_frame_ind].append([_tmp_classe-12, _azi_labels[_frame_ind, _tmp_classe], _ele_labels[_frame_ind, _tmp_classe]])
                        elif _tmp_classe >= 24:
                            _output_dict[_frame_ind].append([_tmp_classe-24, _azi_labels[_frame_ind, _tmp_classe], _ele_labels[_frame_ind, _tmp_classe]])
                        elif _tmp_classe <= 11:
                            _output_dict[_frame_ind].append([_tmp_classe, _azi_labels[_frame_ind, _tmp_classe], _ele_labels[_frame_ind, _tmp_classe]])
                    else:            
                        if _tmp_classe >= 12 and _tmp_classe <= 23 :                        
                            _output_dict[_frame_ind].append([_tmp_classe-12, _x[_frame_ind, _tmp_classe], _y[_frame_ind, _tmp_classe], _z[_frame_ind, _tmp_classe]])
                        elif _tmp_classe >= 24:
                            _output_dict[_frame_ind].append([_tmp_classe-24, _x[_frame_ind, _tmp_classe], _y[_frame_ind, _tmp_classe], _z[_frame_ind, _tmp_classe]])
                        elif _tmp_classe <= 11:
                            _output_dict[_frame_ind].append([_tmp_classe, _x[_frame_ind, _tmp_classe], _y[_frame_ind, _tmp_classe], _z[_frame_ind, _tmp_classe]])
